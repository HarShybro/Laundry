  ...
  return (
    <ScrollView>
      <View style={{ padding: 12, height: 200, backgroundColor: "#FEBE10" }}>
        ...
        >
          <View>
            <Text style={{ fontSize: 13 }}>Hi Harsh!</Text>
            <Text style={{ marginTop: 2, fontWeight: "bold", color: "white" }}>
              Home | Sant Nagar-110084
            </Text>
          </View>
      ...
      >
        <View style={{ flexDirection: "row", gap: 10 }}>
          ...
          <View>
            <Text
              style={{ fontSize: 15, color: "#0066b2", fontWeight: "bold" }}
            >
              QUICK ORDER
            </Text>
            <Text
        ...
        >
          ...
          >
            ...
            <View>
              ...
              >
                select items from the catalog below
              </Text>
              <Text
                style={{
                  fontSize: 11,
      ...
      >
        <View>
          ...
          >
            <View>
              <Text
                style={{ fontSize: 12, fontWeight: "500", color: "#034694" }}
              >
                AFFORDABLE PRICES
              </Text>
      ...
      >
        ...
        >
          Order Within 15 mins to catch the pickUp Slot
        </Text>
        <Pressable
          style={{
            borderColor: "#034694",
